...
import timeit
class PBGENA(object):
    def __init__(self,graph,p,N,alpha,b_t,b_a,f):
        print('\nSetting up PBGENA...')
    ...
    def embed(self):
        ...
        print('Embedding Time + Graph Reading Time = {0}s\n'.format(round(elapsed,4)))
...
if __name__=='__main__':
    ...
    pbgena=PBGENA(graph=args.graph,p=args.p,N=args.N,alpha=args.alpha,b_t=args.b_t,b_a=args.b_a,f=args.f)
