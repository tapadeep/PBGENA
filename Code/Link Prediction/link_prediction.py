...
if __name__=='__main__':
    ...
    link_predictor=LinkPredictor(graph=args.graph,algorithm=args.algorithm,erf=args.erf,N=args.N,alpha=args.alpha,b_t=args.b_t,b_a=args.b_a,l_t=args.l_t,l_a=args.l_a,f_t=args.f_t,f_a=args.f_a)
